...
if(MKL_SDL)
    ...
    find_library(MKL_INTERFACE_LIBRARY ${MKL_INTERFACE_LIBNAME} PATHS ${MKL_ROOT}/lib/intel64/)
    ...
    find_library(MKL_THREADING_LIBRARY ${MKL_THREADING_LIBNAME} PATHS ${MKL_ROOT}/lib/intel64/)

    ####################### Computational layer #####################
    find_library(MKL_CORE_LIBRARY mkl_core PATHS ${MKL_ROOT}/lib/intel64/)
    find_library(MKL_FFT_LIBRARY mkl_cdft_core PATHS ${MKL_ROOT}/lib/intel64/)
    find_library(MKL_SCALAPACK_LIBRARY mkl_scalapack_core PATHS ${MKL_ROOT}/lib/intel64/)
    ...
    find_library(MKL_RTL_LIBRARY ${MKL_RTL_LIBNAME} PATHS ${INTEL_RTL_ROOT}/lib)
